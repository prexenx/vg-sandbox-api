 ...
 */
class MaApiConf extends \AppBundle\Entity\MaApiConf implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaApiConf' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\MaApiConf' . "\0" . 'apiToken', '' . "\0" . 'AppBundle\\Entity\\MaApiConf' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\MaApiConf' . "\0" . 'account'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaApiConf $proxy) {
