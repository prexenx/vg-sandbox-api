 ...
 */
class MaInApiEvents extends \AppBundle\Entity\MaInApiEvents implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaInApiEvents' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\MaInApiEvents' . "\0" . 'action', '' . "\0" . 'AppBundle\\Entity\\MaInApiEvents' . "\0" . 'result', '' . "\0" . 'AppBundle\\Entity\\MaInApiEvents' . "\0" . 'payload', '' . "\0" . 'AppBundle\\Entity\\MaInApiEvents' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\MaInApiEvents' . "\0" . 'account'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaInApiEvents $proxy) {
